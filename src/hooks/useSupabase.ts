...
// (Removidos resquícios sem consumidor: usePickupSummary, useTodayPickupAlerts e seus
//  tipos/helpers — a Home agora usa rpc_home_page direto. 2026-06-07)
...
function mapClienteDetalheHeader(row: Record<string, unknown>): ClienteDetalheHeader {
  const hotel: HotelRow = {
    ...
    pms: (row.pms as string | null) ?? null,
